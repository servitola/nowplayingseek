...
- `VERSION` on `main` still says 2026.07.21 while `main` carries the 2026.07.31 features; the release closes it.
...
- Do the hotkeys work on the installed 2026.07.21? Never confirmed.
