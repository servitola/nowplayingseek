...
What is left, most pressing first. State as of 2026-08-24; delete a line when it is done.
...
- At knob or key-repeat pace a Now Playing refresh caused by an older seek carries a timestamp later
  ...
  review of 2026-08-24, plausible, not measured; a fix would also require the position to be near the
