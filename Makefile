...
SOURCES := $(PURE) src/mediaremote.js src/files.js src/player.js src/configfile.js src/as-nowplaying-cli.js src/as-media-control-help.js src/as-media-control-read.js src/as-media-control.js src/cli.js
