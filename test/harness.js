...
function run(argv) {
    ...
    const core = eval(`${source};({ livePosition, clampTarget, seekBase, seekLanded, expectedPlaying,
        ...
        parseIni, resolveSettings, formatSettings, settingsTemplate, settingAssignment, withSetting, holdContinues, releasedSince, nextHoldTarget, knobRate, knobMultiplier, effectiveRate, seekOvertaken, alreadyThere, formatChapter, orderRaw, humanNotes, withHuman, base64ByteLength, streamChange, playerctlPosition, mpcSeek, playerctlFormat, clock, paintStatus, describeChange, fitToWidth, parseColumns, visibleLength, paintUsage, paintIni, paintJson, paintError, paintChange, logOf, describeState })`);
