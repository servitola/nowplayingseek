...
function run(argv) {
    ...
    const core = eval(`${source};({ livePosition, clampTarget, seekBase, seekLanded, expectedPlaying,
        ...
        parseIni, resolveSettings, formatSettings, holdContinues, releasedSince, nextHoldTarget, knobRate, knobMultiplier, effectiveRate, seekOvertaken, alreadyThere, formatChapter, orderRaw, humanNotes, streamChange, playerctlPosition, mpcSeek, playerctlFormat, clock, paintStatus, paintUsage, paintIni, paintJson })`);
